...
com=ttk.Combobox(win,text="Weather App",values=list_name ,font=("Helvetica",22,"bold"),textvariable=city_name)
...
wb_label=Label(win,text="Weather Description",font=("Helvetica",17))
wb_label.place(x=25,y=330,height=50,width=210)
wb_label1=Label(win,text="",font=("Helvetica",17))
wb_label1.place(x=250,y=330,height=50,width=210)

temp_label=Label(win,text="Temperature()",font=("Helvetica",20))
temp_label.place(x=25,y=400,height=50,width=210)
temp_label1=Label(win,text="",font=("Helvetica",20))
temp_label1.place(x=250,y=400,height=50,width=210)

pres_label=Label(win,text="Pressure",font=("Helvetica",20))
pres_label.place(x=25,y=470,height=50,width=210)
pres_label1=Label(win,text="",font=("Helvetica",20))
pres_label1.place(x=250,y=470,height=50,width=210)

done_button=Button(win,text="Done",font=("Helvetica",20,"bold"),command=data_get)
